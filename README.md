...
- **v3.0.0** (2026-05-03) - 重大版本更新：架构重构与功能增强
  ...
  - 增强邮件服务配置
  - 全面重构前后端代码
  - 详见 [v3.0.0 更新日志](verchanglog/v3.0.0.md)

## 历史版本

- **v2.0.1** (2026-04-27) - RSS 订阅功能增强与系统优化
  - 详见 [v2.0.1 更新日志](verchanglog/v2.0.1.md)

- **v2.0.0** (2026-04-26) - 重大版本更新：RSS 订阅与通知系统
  - 详见 [v2.0.0 更新日志](verchanglog/v2.0.0.md)

- **v1.0.1** (2026-04-16) - RSS 订阅功能增强版本
  - 详见 [v1.0.1 更新日志](verchanglog/v1.0.1.md)

- **v1.0.0** (2026-04-15) - 首个正式版本
  - 详见 [v1.0.0 更新日志](verchanglog/v1.0.0.md)
